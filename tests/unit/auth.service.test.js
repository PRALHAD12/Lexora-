...
jest.unstable_mockModule('@aws-sdk/client-cognito-identity-provider', () => ({
  ...
  ConfirmSignUpCommand: jest.fn((params) => ({ ...params, _type: 'ConfirmSignUp' })),
  InitiateAuthCommand: jest.fn((params) => ({ ...params, _type: 'InitiateAuth' })),
  ForgotPasswordCommand: jest.fn((params) => ({ ...params, _type: 'ForgotPassword' })),
  ConfirmForgotPasswordCommand: jest.fn((params) => ({ ...params, _type: 'ConfirmForgotPassword' })),
  GlobalSignOutCommand: jest.fn((params) => ({ ...params, _type: 'GlobalSignOut' })),
  ChangePasswordCommand: jest.fn((params) => ({ ...params, _type: 'ChangePassword' })),
  GetUserCommand: jest.fn((params) => ({ ...params, _type: 'GetUser' })),
  ResendConfirmationCodeCommand: jest.fn((params) => ({ ...params, _type: 'ResendCode' })),
  AdminGetUserCommand: jest.fn((params) => ({ ...params, _type: 'AdminGetUser' })),
}));
...
const { default: AuthService } = await import('../../src/features/auth/auth.service.js');
